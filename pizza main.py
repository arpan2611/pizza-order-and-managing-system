                    ...
                    while(True):
                        ...
                        if cuchoice==1:
                            ...
                            if order>0:
                                print("==================================     CASH BILL    ================================================")
                                print("----------------------------------------------------------------------------------------------------")
                                print("Sl No.        item              quantity               rate                             total")
                                print("----------------------------------------------------------------------------------------------------")
                                print("1.             pepsi            ",pizzaq,"             Rs.99                             ",pizzaq*99  )
                                print("2.             pepsi            ",pepsiq,"             Rs.75                             ",pepsiq*75  )
                                print("3.             french fries     ",frenq,"              Rs.135                             ",frenq*135 )
                                print("-------------------------------------------------------------------------------------------------------")
                                print("                                                         GRAND TOTAL(incl. of 18% GST)=",(pizzaq*99)+(pepsiq*75)+(frenq*135))
                                print("------------------------------------------------------------------------------------------------------")
                                print("\n \n ")
